...
import {editUser, getProfile} from "../../services/auth/authService";
...
const CreatePasscode = () => {
    ...
    const handleNext = async () => {
        navigation.navigate(NavigationNames.PasscodeSet,{phone})
    }

    return (
        <ScrollView contentContainerStyle={styles.scrollContainer} style={styles.container}>
            <Heading text='Create a Passcode' mb={13} size={32} />
            <Text style={styles.subText}>
                Create a passcode to sign in to your account securely.
                Please don’t share your passcode wiih anyone.
            </Text>
             <OTPTextInput
                ref={otpInput}
                inputCount={6}
            ...
            />
             <PrimaryButton text="Save" mt={130} mb={20} onPress={handleNext} />
        </ScrollView>
    );
};
