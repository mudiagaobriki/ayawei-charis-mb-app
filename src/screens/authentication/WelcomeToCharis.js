...
const WelcomeToCharis = () => {
    ...
    const handleNext = async () => {
        navigation.navigate(NavigationNames.SignIn, {phone})
    }

    return (
        <ScrollView contentContainerStyle={styles.scrollContainer} style={styles.container}>
            <Image source={require('../../assets/success-good.png')} style={styles.icon} />
            <Heading text='Hi Godgift
                Welcome to Charis' mt={90} mb={14} size={32} />
            <Text style={styles.subText}>
                We’re the money app for you and every African on the planet.
            </Text>
             <PrimaryButton text="Sign In" mt={50} mb={40} onPress={handleNext} />
            <Text style={styles.bottomText}>
                By clicking Sign In, you agree with the
...
export default WelcomeToCharis;
